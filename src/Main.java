...
public class Main {
     ...
     */
    private static java.util.Map<String, String> readConfigFile() {
        ...
        printVerbose("Reading configuration from " + configFile.getAbsolutePath());
        ...
        try (java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.FileReader(configFile))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (equalsIndex == -1) {
                    printVerbose("Warning: invalid config line " + lineNum + ": " + line);
                    continue;
                }
                ...
                printVerbose("Config: " + key + " = " + value);
            }
        } catch (IOException e) {
            printVerbose("Warning: could not read config file: " + e.getMessage());
        }
    ...
    public static void main(String[] args) {
        ...
        java.util.Map<String, String> config = readConfigFile();
        ...
        if (config.containsKey("fade")) {
            try {
                ...
                printVerbose("Warning: invalid fade value in config file");
            }
        }
        if (config.containsKey("level")) {
            try {
                ...
                printVerbose("Warning: invalid level value in config file");
            }
        }
        if (config.containsKey("loop")) {
            try {
                ...
                printVerbose("Warning: invalid loop value in config file");
            }
        }
